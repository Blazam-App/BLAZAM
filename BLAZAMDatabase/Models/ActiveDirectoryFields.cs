...
#pragma warning disable CA2211 // Non-constant fields should not be visible
        public static ActiveDirectoryField SN = new() { Id = 1, FieldName = "sn", DisplayName = "Last Name", FieldType = ActiveDirectoryFieldType.Text };
        public static ActiveDirectoryField GivenName = new() { Id = 2, FieldName = "givenname", DisplayName = "First Name", FieldType = ActiveDirectoryFieldType.Text };
        public static ActiveDirectoryField PhysicalDeliveryOffice = new() { Id = 3, FieldName = "physicalDeliveryOfficeName", DisplayName = "Office", FieldType = ActiveDirectoryFieldType.Text };
        public static ActiveDirectoryField EmployeeId = new() { Id = 4, FieldName = "employeeId", DisplayName = "Employee ID", FieldType = ActiveDirectoryFieldType.Text };
        public static ActiveDirectoryField HomeDirectory = new() { Id = 5, FieldName = "homeDirectory", DisplayName = "Home Directory", FieldType = ActiveDirectoryFieldType.Text };
        ...
        public static ActiveDirectoryField ProfilePath = new() { Id = 7, FieldName = "profilePath", DisplayName = "Profile Path", FieldType = ActiveDirectoryFieldType.Text };
        ...
        public static ActiveDirectoryField StreetAddress = new() { Id = 9, FieldName = "streetAddress", DisplayName = "Street Address", FieldType = ActiveDirectoryFieldType.Text };
        public static ActiveDirectoryField City = new() { Id = 10, FieldName = "l", DisplayName = "City", FieldType = ActiveDirectoryFieldType.Text };
        public static ActiveDirectoryField State = new() { Id = 11, FieldName = "st", DisplayName = "State", FieldType = ActiveDirectoryFieldType.Text };
        public static ActiveDirectoryField PostalCode = new() { Id = 12, FieldName = "postalCode", DisplayName = "Zip Code", FieldType = ActiveDirectoryFieldType.Text };
        public static ActiveDirectoryField Site = new() { Id = 13, FieldName = "site", DisplayName = "Site", FieldType = ActiveDirectoryFieldType.Text };
        public static ActiveDirectoryField Name = new() { Id = 14, FieldName = "name", DisplayName = "Name", FieldType = ActiveDirectoryFieldType.Text };
        public static ActiveDirectoryField SAMAccountName = new() { Id = 15, FieldName = "samaccountname", DisplayName = "Username", FieldType = ActiveDirectoryFieldType.Text };
        ...
        public static ActiveDirectoryField POBox = new() { Id = 26, FieldName = "postOfficeBox", DisplayName = "PO Box", FieldType = ActiveDirectoryFieldType.Text };
        ...
        public static ActiveDirectoryField HomeDrive = new() { Id = 28, FieldName = "homeDrive", DisplayName = "Home Drive", FieldType = ActiveDirectoryFieldType.DriveLetter };
        public static ActiveDirectoryField Department = new() { Id = 29, FieldName = "department", DisplayName = "Department", FieldType = ActiveDirectoryFieldType.Text };
        public static ActiveDirectoryField MiddleName = new() { Id = 30, FieldName = "middleName", DisplayName = "Middle Name", FieldType = ActiveDirectoryFieldType.Text };
