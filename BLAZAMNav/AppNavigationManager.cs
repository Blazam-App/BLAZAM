...
namespace BLAZAM.Nav
{
    public class AppNavigationManager
    {
        ...
        public bool WarnOnNavigation { get; set; }
        ...
        public AppNavigationManager(IStringLocalizer<AppLocalization> appLocalization, NavigationManager nav,AppDialogService messageService)
        {
            Nav = nav;
